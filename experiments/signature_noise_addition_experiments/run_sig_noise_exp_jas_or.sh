...
echo "Starting experiment with dataset=$2 and scoring_method=$1 ..."
python signature_noise_experiment.py --dataset "$2" --norm_method mean --dge_on_all pseudobulk --scoring_method "$1" --signature_length 100 --nr_sims 20
echo "FINISHED!"
